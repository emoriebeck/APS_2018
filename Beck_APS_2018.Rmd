...
model_fun <- function(situations){
  ...
  ggsave(sprintf("%s/processes_profile_%s.png", data_path, file), width = 9, height = 4)
}
...
tibble(
  ...
  theme(axis.text = element_text(face = "bold", size = rel(1.2)),
        axis.title = element_text(face = "bold", size = rel(1.2)))
ggsave(sprintf("%s/displacement.png", data_path), width = 6, height = 3)
```
...
pdf(sprintf("%s/agg_nets.pdf", data_path), width = 4, height = 4)
par(mfrow = c(2,2))
gVAR_fit %>%
